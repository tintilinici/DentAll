...
const AddTransportCompanyModal = ({ accommodation, isOpen, onClose }: Props) => {
    ...
    const customDateInput = ({ value, onClick, onChange }, ref) => (
        <Input w="100%" placeholder="Description" onClick={onClick} value={value} ref={ref} onChange={onChange} />
    );
    ...
    function LocationMarker() {
        ...
        return (
            <Marker position={[(formData?.latitude as number ?? 45.815), (formData?.longitude as number ?? 15.982)]}>
                <Popup>
                    {formData?.address}
                </Popup>
            </Marker>
    ...
    return (
        ...
        >
            ...
            <ModalContent maxW="800px">
                ...
                { !accommodation?.id &&
                    <ModalHeader>Add a new accommodation</ModalHeader>
                }
                <ModalCloseButton />
                <form>
                    <ModalBody
                    ...
                    >
                        <Flex flexWrap="wrap" justifyContent="space-between">
                            ...
                            <Flex w="100%" minW="600px" height="500px" position="relative" zIndex="0">
                                <MapContainer center={[(formData?.latitude as number ?? 45.815), (formData?.longitude as number ?? 15.982)]} zoom={13} scrollWheelZoom={false}>
                                    <TileLayer
