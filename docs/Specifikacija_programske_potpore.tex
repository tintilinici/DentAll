\chapter{Specifikacija programske potpore}
	...
	\eject 
			...
			\subsection{Sekvencijski dijagrami}
				...
				\paragraph{Stvaranje, brisanje, dodjeljivanje uloga administratorima – obrazac uporabe UC4, UC5, UC6}\mbox{} \\
				...
				\paragraph{Stvaranje, brisanje i prikaz smještaja na karti – obrasci uporabe UC9, UC11, UC12 }\mbox{} \\
				...
				\begin{figure}[H]
					\includegraphics[scale=0.5]{slike/sd2.PNG} %veličina u odnosu na širinu linije
					\centering
					\caption{Sekvencijski dijagram za UC4, UC5, UC6, UC9, UC11, UC12}
					\label{fig:sd2} %label mora biti drugaciji za svaku sliku
				\end{figure}
				...
				\begin{figure}[H]
					\includegraphics[scale=0.45]{slike/sd3.PNG} %veličina u odnosu na širinu linije
					\centering
					\caption{Sekvencijski dijagram za UC15, UC16, UC18, UC19}
					\label{fig:sd3} %label mora biti drugaciji za svaku sliku
				\end{figure}
				
				\eject
				
				\paragraph{Unos pacijenta, dodjeljivanje smještaja, dohvaćanje termina, dodjeljivanje prijevoza terminima, slanje e-maila – obrasci uporabe UC20, UC21, UC22, UC23, UC24, UC25}\mbox{} \\
				...
				\begin{figure}[H]
					\includegraphics[scale=0.42]{slike/sd4.PNG} %veličina u odnosu na širinu linije
					\centering
					\caption{Sekvencijski dijagram za UC20, UC21, UC22, UC23, UC24, UC25}
					\label{fig:sd4} %label mora biti drugaciji za svaku sliku
				\end{figure}
